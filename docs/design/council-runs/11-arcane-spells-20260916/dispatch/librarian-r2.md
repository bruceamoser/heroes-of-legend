# HOL council — ROUND 2 (rebuttal round), lens: librarian
...
- Read your **round-2 packet**: `/home/bmoser/.hermes/councils/hol-rulebook/runs/20260916-2002/briefs/round-02/librarian.json`
...
- File your finding(s) at `/tmp/hol-council/11-arcane-spells/findings/r2/librarian-r2-<id>.json`,
