# HOL council — ROUND 2 (rebuttal round), lens: <ROLE>
...
- Read your **round-2 packet**: `/home/bmoser/.hermes/councils/hol-rulebook/runs/20260916-2002/briefs/round-02/<ROLE>.json`
...
- File your finding(s) at `/tmp/hol-council/11-arcane-spells/findings/r2/<ROLE>-r2-<id>.json`,
