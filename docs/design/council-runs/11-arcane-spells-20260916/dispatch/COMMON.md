...
2. **Your round-1 packet**: `/home/bmoser/.hermes/councils/hol-rulebook/runs/20260916-2002/briefs/round-01/<ROLE>.json`
...
```
/tmp/hol-council/11-arcane-spells/findings/<ROLE>-r1.json
```
