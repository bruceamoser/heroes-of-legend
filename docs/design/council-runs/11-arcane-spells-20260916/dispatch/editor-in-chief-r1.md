...
2. **Your round-1 packet**:
   `/home/bmoser/.hermes/councils/hol-rulebook/runs/20260916-2002/briefs/round-01/editor-in-chief.json`
...
```
/tmp/hol-council/11-arcane-spells/findings/r1/editor-in-chief-r1-<id>.json
```
...
## YOUR LENS — editor-in-chief

**Your role card:** `/home/bmoser/repos/synod/references/roles/hol/editor-in-chief.md`

You are the FINAL-QUALITY lens: structure, cross-references, missing content, completeness. Aim hardest at: (a) whether the chapter is COMPLETE as a player-facing unit - does it define how its own spells are cast, targeted, sustained and ended, or does every one of the 68 cards assume the magic-system chapter; (b) the section structure against the tier spread each section prints, and whether a reader can navigate by Discipline; (c) every cross-reference, heading level and label in the file, and whether the glossary and reference sheets carry these cards; (d) any card whose tier, Discipline key or Requires tag is inconsistent with its neighbours, and any residue of an earlier pass that contradicts the rest of the file. Name what a reader would be unable to do after reading it.
