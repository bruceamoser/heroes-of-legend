...
She rolls 3d6 + Knowledge (+2) + no skill. Rolls 3, 4, 4 = 11 + 2 = 13. **Standard.** The gust slams into both cultists, they must make Fortitude saves or be knocked Prone. Cultist 1 fails (rolls 4). Cultist 2 passes (rolls 10). One cultist goes sprawling, his chant broken. Lyra spends her Maneuver to Defend, +2 Protection Value.
...
"Shield Block!" Kael declares, spending his reaction. The Knight's Strong damage drops to Standard: 4 damage − DR 2 = 2 damage. Kael drops to 9 HP instead of 8. The Knight's blade skids off Kael's raised buckler.
...
**End of Round 1.** The party has dealt 2 total damage to the Knight (Kael's 1, Roric's 0). The cultists dealt 3 to Lyra. The Knight dealt 2 to Kael (reduced from 3 by Shield Block). Nobody is down. Everyone is engaged. The next round will be decisive.
...
Spark roll: 3d6 + Knowledge (+2). Rolls 6, 6, 1 = 13 + 2 = 15. **Strong.** Spark Strong damage: 4 fire. Cultist has no armor. 4 damage straight through. The cultist screams as fire catches his robes.
...
Roric rolls for the Knight: 3, 2, 1 = 6. **Weak.** The Knight lowers his sword. "Enough," he growls. "You fight well. The Iron Circle withdraws." He drags the wounded cultist to his feet. They retreat into the shadows of the temple.
