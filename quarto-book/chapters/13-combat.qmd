...
| **Weak (1-6)** | Flees or surrenders. Fight's over for this one. |
...
| Result | Outcome |
|--------|---------|
| **Strong (13+)** | You stabilize at 1 HP. You're back in the fight, barely. |
| **Standard (7-12)** | You remain unconscious but stable. Not getting worse. |
| **Weak (1-6)** | Take 1 wound. You're still dying. |
...
"Maneuver: I'm using **Menacing Glare** from Intimidation Adept." The Knight must make a Morale Check. The DA rolls for the Knight: 3d6. Rolls 2, 1, 4 = 7. **Standard.** The Knight wavers, disadvantage on his next attack.
