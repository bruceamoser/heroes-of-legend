...
She rolls 3d6 + Knowledge (+2) + no skill. Rolls 3, 4, 4 = 11 + 2 = 13. **Standard.** The blast of wind slams into the cultist, knocking him Prone. No save. Gust resolves by tier. The cultist goes sprawling, his chant broken. Lyra spends her Maneuver to Defend, +2 Protection Value.
...
Rolls 3d6 + Brawn (+1) + Long Blades (+2). Rolls 5, 4, 5 = 14 + 3 = 17. **Strong.** Longsword Strong damage: 5. Knight's plate armor: DR 4. 5 - 4 = 1 damage. The blade finds a gap at the Knight's gorget, a thin line of blood. Not a killing blow, but the Knight knows Kael can hurt him.
...
Kael has Agility +1 and no Defense skill. He rolls 3d6 + 1 − 3 = 3d6 − 2. Rolls 5, 3, 2 = 10 − 2 = 8. **Weak.** The Knight's Strong damage: 5. Kael's leather armor: DR 2. 5 − 2 = 3 damage. Kael drops from 11 HP to 8 HP.

"Shield Block!" Kael declares, spending his reaction. The Knight's Strong damage drops to Standard: 3 damage. Leather armor DR 2 reduces it to 1. Kael drops to 10 HP instead of 8. The Knight's blade skids off Kael's raised buckler.
...
Rolls 3d6 + Brawn (+2) + Long Hammers Novice (+1). Rolls 3, 3, 2 = 8 + 3 = 11. **Standard.** Warhammer Standard damage: 3. Knight's armor: DR 4. 3 − 4 → minimum 1 damage. The hammer rings off the Knight's breastplate, but the force behind it still draws a grunt. Roric's not done.
...
**End of Round 1.** The party has dealt 2 total damage to the Knight (Kael's 1, Roric's 1). The cultists dealt 3 to Lyra. The Knight dealt 1 to Kael (reduced from 3 by Shield Block). Nobody is down. Everyone is engaged. The next round will be decisive.
...
Firebolt roll: 3d6 + Knowledge (+2). Rolls 6, 6, 1 = 13 + 2 = 15. **Strong.** Firebolt Strong damage: 6 fire. The cultist has no armor. 6 damage straight through. The cultist screams as fire engulfs his robes, collapsing in a heap.

The chaos of the blast catches: Lyra's spell may not need Fire, but the backlash from bending the rules doesn't care. The second cultist, standing too close to his screaming ally, is singed for 2 damage, now bloodied and barely standing. The downed cultist is beyond saving.
...
Rolls 3d6 + Brawn (+1) + Long Blades (+2). Rolls 4, 6, 5 = 15 + 3 = 18. **Strong.** Longsword Strong damage: 5. Knight's DR: 4. 5 - 4 = 1 damage. Total damage on Knight: 3 (2 from Round 1 + 1 now). The blade slips under the Knight's pauldron, deeper this time. The Knight grunts.
...
The Knight has taken 3 damage, not much, but he's down to 17 HP from 20. One cultist is down, the other barely standing. The party is coordinated and the Protector hasn't even been hit yet. The DA calls for a Morale Check.

Roric rolls for the Knight: 3, 2, 1 = 6. **Weak.** The Knight lowers his sword. "Enough," he growls. "You fight well. The Iron Circle withdraws." He hauls the fallen cultist over his shoulder and retreats into the shadows of the temple.
