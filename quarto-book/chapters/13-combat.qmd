...
Skill-granted maneuvers are listed on each skill's card in `@sec-chapter-skills`{=typst}. They're typically more powerful than basics and require Adept or Master rank. You earn those. They're not free.
...
- **Critical (three 6s):** Maximum Strong damage plus a bonus effect from the Critical table (`@sec-chapter-core-resolution`{=typst}).
