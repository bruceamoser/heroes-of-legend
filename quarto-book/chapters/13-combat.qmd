...
| Result | Outcome |
|--------|---------|
| **Critical (three 6s)** | You snap awake at half HP. Three natural 6s overrides all tier results. Someone up there likes you. |
...
| **Fumble (three 1s)** | Death. Three natural 1s overrides all tier results. The table goes quiet. |
