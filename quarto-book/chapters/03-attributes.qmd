...
![Placeholder: Six iconic figures embodying the attributes: Brawn (warrior), Fortitude (dwarf), Agility (elf archer), Guile (rogue), Knowledge (scholar), Reason (wizard).](../assets/images/placeholder-ch03-attributes.png){width=80%}
...
**Reason (RE):** What you *do* with what you know. Reason is the engine behind divine spellcasting, alchemy, crafting, and puzzle-solving. Knowledge tells you that trolls fear fire; Reason tells you how to make some. A shepherd with Reason +2 doesn't just channel divine power, they understand *why* the gods listen, which makes them devastatingly effective.
