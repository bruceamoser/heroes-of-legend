...
**If she'd rolled Weak (1-8):** The Poisoned condition kicks in, Bane on all attacks. She's in trouble. The party needs to end this fight fast or get her an antidote.
...
**The roll:** 3d6 + Knowledge (+2) + History Novice (+1). Sera, the party's Intellect, rolls 2, 6, 4 = 12 + 3 = 15. **Strong.**
...
Zara, a Shepherd of the wild gods, prays for divine guidance in a corrupted temple. The air is heavy with malice, and her party needs to know what lurks beyond the next door.

**The roll:** 3d6 + Reason (+2) + Religion Novice (+1). Zara rolls 1, 6, 5 = 12 + 3 = 15. **Strong.**

She doesn't just sense danger. She receives a vision: three cultists around a blood altar, the High Priest at the center with a blade, a hidden door behind the tapestry. Every threat mapped. Every detail clear. Reason channels divine insight, and the gods speak plainly.
