...
General Disciplines follow a tiered substitution rule: at Novice, one General substitutes for one specific Discipline (1:1). At Master, two General Disciplines substitute for one specific Discipline (2:1). General Disciplines cannot substitute at the Adept tier. With level gates in place, a clever caster can have their Master prerequisites lined up by level 3 using General Disciplines, but they still must hit level 7 before the Master tier unlocks — and those Generals won't be available for other pursuits.
