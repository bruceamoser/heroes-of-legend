...
| **Flame Tongue** | Rare | +2 fire damage. Requires 1 Fire Discipline. |
| **Shield +1** | Uncommon | +1 DR while wielded. |
| **Cloak of Elvenkind** | Uncommon | Boon on Stealth checks. The cloak shifts color to match its surroundings. |
| **Ring of Protection** | Rare | +1 DR, +1 to all saves. Simple. Powerful. |
| **Staff of Power** | Very Rare | +2 damage (flat) to spell damage. |
...
**Activated, Storm Bolt (Action, once per encounter):** You point at a creature within 60 ft. A bolt of lightning descends from above.
...
**Always On:** You have Boon on Brawn checks to grapple, shove, or resist being moved.
...
| **Strong** | All allies lose Frightened and gain +1 on their next roll. Undead within 60 ft take 6 radiant damage. |
...
**Activated, Dagger Step (Maneuver, once per encounter):** You throw the dagger at a shadow within 60 ft and step through. You vanish from your position and reappear where the dagger lands.
...
**Always On:** +2 DR (as a standard shield). You have Boon on all saving throws against spells and magical effects.
...
**Always On:** DR 7 (Plate is normally 6). Any critical hit scored against you becomes a normal hit instead, the attack deals Standard damage. This does not prevent fumble effects against you.
...
**Activated, Drink (Maneuver):** You drink the elixir. Choose acid, cold, fire, or lightning. You exhale a 30-ft cone of that energy type. The effect resolves immediately, you can't hold it in.
...
**Always On:** You have Boon on all Agility checks made to swim, dive, or escape grappling creatures underwater.
...
- **Levels 7-10:** Mostly Rare, one Very Rare for the party. Very Rare and Legendary items. Items with W/S/S effects become available. These should feel earned, quest rewards, not shop purchases.
