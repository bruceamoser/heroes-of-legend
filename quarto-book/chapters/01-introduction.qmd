...
#image("assets/images/page003-img002.jpeg", width: 60%)

_Illustration 2: Opening chapter decorative art. Placeholder; final art TBD. Dimensions: 185×185._

#pagebreak()

Welcome to _Heroes of Legend_. If you're holding this book, you're about to do something remarkable: build a hero, step into their boots, and tell stories you'll remember for years. This is a game about rolling dice and making choices, but mostly it's about sitting around a table with your friends and saying, "Remember that time Kael charged the dragon?"

Here's how it works.

You create a hero: a *Protector*, a *Blade*, an *Arcanist*, or one of six other classes, each with their own way of approaching the world. One player takes on the role of the *Dungeon Architect* (*DA*). The DA describes the world. You decide what your hero does. The dice tell you how it goes.
...
#figure(image("assets/images/placeholder-hero-party.png", width: 100%), caption: [Placeholder: A party of four adventurers at the threshold of an ancient temple doorway, about to step into darkness. Warm torchlight from within, cool moonlight from behind.])
...
Pull up a chair. Let me tell you what you _actually_ need to play this game. I've seen players show up with custom dice towers, hand-painted miniatures, and leather-bound notebooks that cost more than my first sword. You know what the best sessions all had in common? None of that stuff.
...
#figure(image("assets/images/placeholder-minimal-kit.png", width: 60%), caption: [Placeholder: A flat-lay of the minimal play materials: rulebook open, three dice, a pencil, and a character sheet with handwritten notes. Warm kitchen-table lighting.])

#callout(type: "important", title: "Combat Is Tactical", body: [
One thing, though. I do recommend some graph paper or a gridded surface. Combat in _Heroes of Legend_ is tactical: positioning matters, cover matters, who's standing next to whom matters. A quick sketch of the battlefield helps everyone see the fight. It's the difference between "I attack the goblin" and "I circle around the pillar, use it as cover, and strike from the goblin's blind spot." The rules work fine either way; theater of the mind is perfectly valid, but a rough map turns a brawl into a battle. And battles are more fun.
])
...
#callout(type: "tip", title: "Played Another RPG Before? Here's What's Different.", body: [
...
In _Heroes of Legend_, whenever you attempt something with risk: swinging a sword, casting a spell, talking your way past a guard, climbing a crumbling wall while something with too many teeth chases you, you reach for three six-sided dice. You roll them. You add your hero's relevant *attribute* (see @sec-chapter-attributes). You add your *skill* bonus if you have one. The DA may add or subtract a modifier for difficulty. Then you look at the total. That number tells you what happens.

But numbers without context are just arithmetic. Here's what those totals _feel_ like at the table:
...
*Strong (15–18+):* You make it look easy. The crowd gasps. The enemy reels. The thing you were trying to do? You did it so well that something extra happens: bonus damage, bonus information, a moment of pure triumph that'll have the table on its feet. Strong results are rare enough to feel special and common enough to feel earned. This is the moment you'll be talking about after the session.

Three natural 6s is a *Critical*: automatic Strong plus a bonus effect. The dice came up 6, 6, 6. Three natural 1s is a *Fumble*: automatic failure with a twist. Something has gone spectacularly, memorably wrong. Both are rare. When they do, they're not just numbers. They're stories.

Everything else in this book, skills, spells, equipment, monsters, hangs on that one roll. Master it and you've mastered the game.

Now go grab three dice. Roll them. Look at the numbers. Imagine adding your best attribute, the thing your hero is _exceptional_ at. That's a Strong. Now imagine adding nothing, just raw luck. That's probably a Standard. Now imagine rolling three ones. That's the universe laughing at you. It happens to everyone. Even heroes.
...
#figure(image("assets/images/placeholder-bell-curve.png", width: 80%), caption: [Placeholder: A diagram of the 3d6 probability bell curve with the three success tiers color-coded beneath: Weak (1–8) in amber, Standard (9–14) in green, Strong (15–18+) in gold.])

#callout(type: "important", title: "The Only Rule You Need to Memorize", body: [
+ *Roll 3d6* whenever you attempt something risky.
+ *Add* your attribute modifier + skill bonus + any DA modifiers.
+ *Check the total:* 1–8 = Weak, 9–14 = Standard, 15–18+ = Strong.
...
In _Heroes of Legend_, attacks always hit. Always. Read that again. When you swing your sword at a goblin, you connect. When you hurl a firebolt at a troll, it lands. Every. Single. Time.

This is not how most games work. In most games, you roll to see _if_ you hit. If you miss, your turn ends. Nothing happens. The dragon you're fighting stands there, entirely unharmed, while four heroes take turns swinging at the air around it. That's not drama. That's dead air.

In _Heroes of Legend_, every swing connects. Your 3d6 roll determines the damage tier: Weak, Standard, or Strong. A Weak hit is a glancing blow that still draws blood. A Standard hit is a solid strike. A Strong hit is the kind of blow that makes the enemy reconsider every choice that led them to this moment. Something always happens. Every swing advances the fight. Every round, the board changes.
...
Kael is a dwarf Blade, a fighter who has learned that the best way to protect his friends is to be the threat nobody can ignore. He strikes with precision, not fury, and when his longsword is in his hand, the enemy watches him, which is exactly what he wants. Lyra is a halfling Odd, an unpredictable wildcard whose enemies never know what she'll do next, and neither do her friends, honestly. (You'll meet Kael and Lyra in @sec-chapter-opening-fiction.) They're seasoned adventurers, several levels into their careers: Lyra's Stealth has grown to Adept, which unlocks at level 3, and Kael has learned to make himself the opening his friends need. Their DA, Morgan, has been running them through a goblin-infested ruin for the past hour. They've just kicked down the door to the chieftain's chamber.
...
_Kael grabs three dice. The table goes quiet. He shakes them in his hand, everyone has their ritual, and lets them fly._

_Kael rolls:_ "Four, three, five. That's twelve. My *Brawn* is +1. Total is thirteen."

*Morgan:* "Thirteen is Standard. Your longsword's Standard damage is 2, plus your Brawn: 3."

*Morgan:* "Crude leather armor. DR 2. That's 3, reduced to 1."
...
#figure(image("assets/images/placeholder-dice-closeup.png", width: 40%), caption: [Placeholder: A close-up shot of three six-sided dice on a wooden table showing 4, 3, and 5, the exact roll from the example.])
...
_Lyra rolls. She doesn't shake the dice, she just drops them, casual, like she's not doing anything important._

_Lyra rolls:_ "Five, four, six. That's fifteen. *Agility* +2, Stealth Adept +2. Nineteen total."
...
This is _Heroes of Legend._ Every roll drives the story forward. Every success tier changes the scene. And sometimes, just sometimes, you find an explosive keg behind the boss's chair. What you do with it, that's up to you.

#pagebreak()

#image("assets/svg/divider-rule.svg")
...
#figure(image("assets/images/placeholder-designers-desk.png", width: 70%), caption: [Placeholder: A behind-the-scenes illustration: a desk covered with playtest notes, hand-drawn probability tables, scratched-out mechanic ideas, coffee cups, and a scattering of dice.])

== Design Justifications: Why We Built It This Way
#label("sec-design-justifications")
...
#callout(type: "note", title: "Always-Hit: Something Always Happens", body: [
I've watched casters spend entire sessions saying "I miss," and I built this game so that never has to happen. Attacks always connect; the roll only decides how hard. For the full rationale, and how armor reduces damage instead of preventing hits, see @sec-chapter-core-resolution
])

#callout(type: "note", title: "3d6 Instead of d20: Your Training Matters More Than Your Luck", body: [
I chose three six-sided dice over a twenty-sided die so that your attributes, skills, and Disciplines matter more than luck. For the full designer's note, see @sec-chapter-core-resolution
])

#callout(type: "note", title: "No Spell Slots: Magic Always Fires", body: [
...
In _Heroes of Legend_, magic always fires. No mana. No slots. No "sorry, I used my good spell already." When you cast, the spell goes off. The roll determines whether it's a Weak sputter, a Standard blast, or a Strong inferno. You're never useless. You're never out of options. Your fire burns until _you_ decide it stops.

Adept spells are per-encounter, and Master spells per-session (see @sec-chapter-magic-system), not because we want you counting gas, but because Master-tier effects reshape the battlefield. Those limits are about spotlight management, not resource attrition. When you unleash a Master spell, it should be a moment everyone remembers, not something you do three times before lunch.
])

#callout(type: "note", title: "Flat Damage & Disciplines: Speed and Freedom", body: [
Two more things worth understanding. *Flat damage* means no separate damage dice, no arithmetic slowdown. The combat chapter (@sec-chapter-combat) covers this in full. *Disciplines* mean no class-locked skills: anyone can learn anything, it just costs more outside your wheelhouse. The disciplines chapter (@sec-chapter-disciplines) explains the full system.
])

These are the big ideas. The rest of the book explains how they work in practice.

#callout(type: "tip", title: "Ready to Begin?", body: [
- *New player?* Turn to @sec-chapter-character-creation and build your first hero.
- *New DA?* Skim @sec-chapter-attributes through @sec-chapter-disciplines, then dig into @sec-chapter-gm-guidance
- *Just browsing?* Read @sec-chapter-opening-fiction in the next chapter to meet Kael and his companions in action.
...
#figure(image("assets/images/placeholder-chapter-close.png", width: 30%), caption: [Placeholder: A small decorative vignette: a closed rulebook with dice resting on top, a candle burning low, and a character sheet peeking out from beneath.])
```
