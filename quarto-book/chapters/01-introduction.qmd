...
For the full always-hit rationale, and how armor reduces damage instead of preventing hits, see @sec-chapter-core-resolution and @sec-chapter-armor-shields.
...
*Kael rolls:* "Four, three, five. That's twelve. My **Brawn** is +1, and I've got Long Blades at **Adept** (see @sec-chapter-skills), so that's another +2. Total is fifteen."

**Morgan:** "Fifteen is Strong. Your longsword's Strong damage is 5, plus your Brawn: 6."

**Morgan:** "Crude leather armor. That's 6, reduced to 5."
...
Adept and Master spells have per-encounter and per-session limits (see @sec-chapter-magic-system), not because we want you counting gas, but because Master-tier effects reshape the battlefield. Those limits are about spotlight management, not resource attrition. When you unleash a Master spell, it should be a moment everyone remembers, not something you do three times before lunch.
