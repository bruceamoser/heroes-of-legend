...
In *Heroes of Legend*, armor doesn't make you harder to hit: every attack connects. Instead, armor subtracts from incoming damage down to a minimum of 1 per hit. A goblin's club (Standard damage 3) against plate armor (DR 6) still deals minimum 1 damage — every blow finds a gap. A Young Dragon's claws (Standard damage 5) fare the same against that steel shell, though its Strong damage would be another matter entirely.
