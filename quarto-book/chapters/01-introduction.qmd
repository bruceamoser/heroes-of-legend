...
// Ends the roman front-matter folios; the body continues the same count in Arabic
// (folios are continuous, so the printed folio equals the PDF page number). See style.typ
// for why the body does not restart at 1.
#hol-body-start()
...
#image("assets/images/placeholder-hero-party.png", width: 100%)

_Figure 2.1: Hero Party_
...
#image("assets/images/placeholder-minimal-kit.png", width: 60%)

_Figure 2.2: Minimal Kit_
...
#image("assets/images/placeholder-bell-curve.png", width: 80%)

_Figure 2.3: Bell Curve_
...
*Kael:* "I draw my shortsword and step forward. 'You're in my spot.' I strike."

*Morgan:* "Roll 3d6."

_Kael grabs three dice. The table goes quiet. He shakes them in his hand, everyone has their ritual, and lets them fly._

_Kael rolls:_ "Four, three, five. That's twelve. My *Agility* is +2, and a shortsword is Finesse. Total is fourteen."

*Morgan:* "Fourteen is Standard. Your shortsword's Standard damage is 2, plus your Agility: 4."

*Morgan:* "Crude leather armor. DR 2. That's 4, reduced to 2."
...
#image("assets/images/placeholder-dice-closeup.png", width: 40%)
...
#image("assets/images/placeholder-designers-desk.png", width: 70%)

_Figure 2.5: Designers Desk_
...
I've watched casters spend entire sessions saying "I miss," and I built this game so that never has to happen. Attacks always connect; the roll only decides how hard. For the full rationale, and how Damage Reduction softens a hit instead of preventing it, see @sec-chapter-core-resolution
])
...
- *New DA?* Skim @sec-chapter-attributes through @sec-chapter-disciplines and then dig into @sec-chapter-gm-guidance
...
#image("assets/images/placeholder-chapter-close.png", width: 30%)

_Figure 2.6: Chapter_
```
