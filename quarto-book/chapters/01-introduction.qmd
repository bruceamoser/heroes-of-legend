...
![](../assets/images/page003-img002.jpeg){width="60%"}
...
![Placeholder: A party of four adventurers at the threshold of an ancient temple doorway, about to step into darkness. Warm torchlight from within, cool moonlight from behind.](../assets/images/placeholder-hero-party.png){width=100%}
...
![Placeholder: A flat-lay of the minimal play materials: rulebook open, three dice, a pencil, and a character sheet with handwritten notes. Warm kitchen-table lighting.](../assets/images/placeholder-minimal-kit.png){width=60%}
...
![Placeholder: A diagram of the 3d6 probability bell curve with the three success tiers color-coded beneath: Weak (1–8) in amber, Standard (9–14) in green, Strong (15–18+) in gold.](../assets/images/placeholder-bell-curve.png){width=80%}
...
This is not how most games work. In most games, you roll to see *if* you hit. If you miss, your turn ends. Nothing happens. The dragon you're fighting stands there, entirely unharmed, while four heroes take turns swinging at the air around it. That's not drama. That's dead air.

In *Heroes of Legend*, every swing connects. Your 3d6 roll determines the damage tier: Weak, Standard, or Strong. A Weak hit is a glancing blow that still draws blood. A Standard hit is a solid strike. A Strong hit is the kind of blow that makes the enemy reconsider every choice that led them to this moment. Something always happens. Every swing advances the fight. Every round, the board changes.
...
*Kael rolls:* "Four, three, five. That's twelve. My **Brawn** is +1. Total is thirteen."
...
![Placeholder: A close-up shot of three six-sided dice on a wooden table showing 4, 3, and 5, the exact roll from the example.](../assets/images/placeholder-dice-closeup.png){width=40%}
...
![Placeholder: A behind-the-scenes illustration: a desk covered with playtest notes, hand-drawn probability tables, scratched-out mechanic ideas, coffee cups, and a scattering of dice.](../assets/images/placeholder-designers-desk.png){width=70%}
...
![Placeholder: A small decorative vignette: a closed rulebook with dice resting on top, a candle burning low, and a character sheet peeking out from beneath.](../assets/images/placeholder-chapter-close.png){width=30%}
