...
**Giant Spider (Challenge 1):** HP 10, DR 0. Bite: 2/3/5 + poison (Fortitude save or Poisoned condition). Web (Recharge): ranged attack that Restrains target on hit.
...
**Archmage (Challenge 6):** HP 14, DR 2. Dagger: 1/2/3. Firebolt: 2/3/5 (at will). Fireball: 6/9/12 (once per encounter). Counterspell: reaction to negate a spell. Magical Ward: +2 DR vs spells.
...
**Light Vulnerability:** While in bright light, all attacks against the stalker are at Boon, and its damage tier is reduced by one.
