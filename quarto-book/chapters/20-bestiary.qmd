...
**Bite:** 2/3/5 + poison (Fortitude save or Poisoned condition).
...
**Archmage (Challenge 6):** HP 14, DR 2. Dagger: 1/2/3. Firebolt: 2/4/6 (at will). Fireball: 6/9/12 (once per encounter). Counterspell: reaction to negate a spell. Magical Ward: +2 DR vs spells.
...
**Goblin Shaman (Challenge 1):** HP 8, DR 0. Staff: 1/2/3 bludgeoning. Hex Bolt: 2/4/6 necrotic (range 60 ft). Hex (Recharge): one target within 30 ft must make a Guile save or suffer Bane on its next attack roll. Goblin Cunning: can use a Maneuver to Disengage. Darkvision: 60 ft.

{{< pagebreak >}}

## Orcs

**Orc (Challenge 1/2):** HP 10, DR 1 (hide). Greataxe: 3/4/5 slashing. Javelin: 2/3/4 piercing (range 30/120). Relentless: once per day, when reduced to 0 HP, the orc can make a Fortitude save. On a Strong result, it stays at 1 HP. Aggressive: can use a Maneuver to move up to its Speed toward a visible enemy.

**Orc Warchief (Challenge 3):** HP 22, DR 3 (plate). Greataxe: 4/5/7 slashing. Javelin: 3/4/6 piercing (range 30/120). Multiattack: Greataxe twice. War Cry (Recharge): all orc allies within 30 ft gain +1 damage tier on their next attack. Relentless: as Orc. Commanding Presence: orc allies within 30 ft are immune to Frightened.
...
**Zombie (Challenge 1/2):** HP 12, DR 1. Slam: 2/3/4. Relentless: when reduced to 0 HP, roll Fortitude. On Strong, stays at 1 HP. Slow: always acts last in initiative.

**Ghoul (Challenge 1):** HP 10, DR 0. Claw: 2/4/6. Bite: 3/4/6. Paralyzing Touch: on Strong claw hit, target must make Fortitude save or be Paralyzed for 1 round.
...
**Green Hag (Challenge 3):** HP 16, DR 2. Claw: 3/4/6. Illusory Appearance: appears as any humanoid. Vicious Mockery: 2/4/6 psychic + Bane on next attack (at will). Coven Magic: when 3 hags are within 30 ft, they share spellcasting.
...
**Fire Elemental (Challenge 4):** HP 20, DR 2. Slam: 4/5/7 fire. Touch: creatures touching or hitting the elemental take 2 fire. Vulnerable: Water (takes 2 cold damage when splashed with water).
...
**Hill Giant (Challenge 5):** HP 30, DR 2. Greatclub: 5/7/10. Rock: 4/6/9 (range 60/240). Slow-Witted: Bane on Knowledge, Reason, and Guile saves.
...
**Ogre (Challenge 2):** HP 20, DR 2 (thick hide). Greatclub: 4/5/7 bludgeoning. Rock: 3/4/6 bludgeoning (range 30/90). Reach 10 ft. Slow-Witted: Bane on Knowledge, Reason, and Guile saves. Hulking Brute: the ogre deals +1 damage tier to objects and structures.

{{< pagebreak >}}

## Extraplanar

**Vrock (Demon, Challenge 6):** HP 25, DR 3. Claw: 4/5/7. Bite: 3/4/6. Spores (Recharge): all within 15 ft take 4/6/9 poison. Stunning Screech (1/day): all within 30 ft must make Fortitude save or be Stunned for 1 round. Magic Resistance: Boon on saves vs spells.

**Barbed Devil (Challenge 5):** HP 22, DR 4. Claw: 3/4/6 + 2 fire. Tail: 4/5/7 piercing. Barbed Hide: creatures grappling or hitting with melee take 2 piercing. Magic Resistance: Boon on saves vs spells.
...
**Shadow Claw:** 3/4/6 necrotic. Target's shadow is torn, Bane on Stealth until the end of the encounter.
...
Assign attributes (-2 to +2), give 1-3 attacks with W/S/S damage per the damage budget (@sec-damage-budget), add 1-2 abilities. HP = 5 × Challenge. DR = Challenge ÷ 2 (round down), based on natural armor (max 6).

**Quick Monster Template:**

1. Choose type (Beast, Undead, etc.)
2. Set Challenge (1-12)
3. HP = 5 × Challenge, DR = Challenge ÷ 2 (round down)
