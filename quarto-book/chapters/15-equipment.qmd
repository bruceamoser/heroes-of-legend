...
| **Warhorse** | 400 gp | 35 | 50 ft | 500 lbs | Trained for combat. Does not require Athletics checks to control in battle. |
...
**Controlling a Mount:** You direct your mount using the Command maneuver, no roll required for trained mounts (warhorses, riding horses with riders who have Athletics). For untrained mounts or in chaotic situations (explosions, dragon fear, the horse just took an arrow), the DA may require an Athletics check (Standard) to keep control.

**Fighting from a Moving Mount:** Ranged attacks made from a moving mount suffer a -2 penalty. The horse's gait throws off your aim. If you have Athletics at Adept or higher, this penalty is reduced to -1. At Master rank, you ignore it entirely, you could thread an arrow through a keyhole at full gallop.
