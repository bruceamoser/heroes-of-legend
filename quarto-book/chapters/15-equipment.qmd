...
| Weapon | Disciplines Required | Damage (W/S/St) | Attribute |
|--------|---------------------|-----------------|-----------|
| Unarmed | None | 1 / 1 / 2 | + Brawn |
| Dagger | 1 Blades | 1 / 2 / 3 | + Brawn |
| Shortsword | 2 Blades | 2 / 3 / 4 | + Brawn |
| Longsword | 2 Blades | 2 / 3 / 5 | + Brawn |
| Greatsword | 2 Blades + 1 Heavy Weapon | 3 / 5 / 8 | + Brawn |
| Handaxe | 1 Axes | 2 / 3 / 5 | + Brawn |
| Battleaxe | 1 Axes | 3 / 4 / 6 | + Brawn |
...
| Halberd | 1 Polearms + 1 Axes | 3 / 5 / 7 | + Brawn |
...
::: {.callout-note}
## Melee Damage
Melee weapons add your Brawn to every damage result (minimum 1). Features like the Blade's Swift Blade may substitute Agility. Missile weapons and ammunition deal their listed flat damage.
:::
