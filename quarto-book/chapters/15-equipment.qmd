...
The tables in this chapter list weapons by damage tier, armor by damage reduction, and adventuring gear by utility. Prices are in gold pieces (gp), the standard currency of the realms. A laborer earns about 1 gp a month. Prices vary by region and availability; the DA sets the cost in their world. Keep that in mind when you're haggling with the blacksmith. You're not just buying gear, you're spending someone's annual salary.

{{< pagebreak >}}

## Weapons

Every weapon has fixed Weak, Standard, and Strong damage values. Melee weapons add your Brawn (or another attack attribute via features like Swift Blade) to every damage result. The 3d6 attack roll already determined how well you struck. No separate damage dice.

| Weapon | Disciplines Required | Damage (W/S/St) | Attribute | Cost |
|--------|---------------------|-----------------|-----------|------|
| Unarmed | None | 1 / 1 / 2 | + Brawn | |
| Dagger | 1 Blades | 1 / 2 / 3 | + Brawn or Agility (Finesse) | |
| Shortsword | 1 Blades | 2 / 3 / 4 | + Brawn or Agility (Finesse) | |
| Longsword | 2 Blades | 2 / 3 / 5 | + Brawn | |
| Greatsword | 2 Blades + 1 Heavy Weapon | 3 / 5 / 8 | + Brawn | |
| Handaxe | 1 Axes | 2 / 3 / 5 | + Brawn | |
| Battleaxe | 2 Axes | 3 / 4 / 6 | + Brawn | |
| Greataxe | 2 Axes + 1 Heavy Weapon | 3 / 5 / 8 | + Brawn | |
| Mace | 1 Heavy Weapon | 1 / 2 / 3 | + Brawn | |
| Warhammer | 2 Heavy Weapon | 2 / 3 / 5 | + Brawn | |
| Maul | 3 Heavy Weapon | 3 / 5 / 8 | + Brawn | |
| Spear | 1 Polearms | 2 / 3 / 4 | + Brawn | |
| Halberd | 1 Polearms | 3 / 5 / 7 | + Brawn | |
| Throwing Dagger | 1 Blades or 1 Archery | 1 / 2 / 3 | + Brawn or Agility (Finesse) | 2 gp |
| Shortbow | 1 Archery | 2 / 3 / 4 | | |
| Longbow | 1 Archery | 3 / 4 / 6 | | |
| Crossbow | 1 Archery | 3 / 5 / 7 | | |

::: {.callout-note}
## Kit Weapons
Your class starting kit assumes training with its gear: you can wield kit weapons regardless of Discipline prerequisites (skills still matter for maneuvers).
:::

::: {.callout-note}
## Melee Damage
Melee weapons add your Brawn to every damage result (minimum 1). Finesse weapons use Agility instead of Brawn for attack and damage, and features like the Blade's Swift Blade may substitute Agility. Missile weapons and ammunition deal their listed flat damage.
:::

::: {.callout-note}
## Discipline Combinations, Build Your Fighting Style

Weapons don't just require more of the same Discipline, they require specific combinations. A Longsword needs *2 Blades*. A Greatsword needs *2 Blades + 1 Heavy Weapon*. This means your Discipline choices define your fighting style. A warrior with 2 Blades can wield a Longsword with precision, but a Greatsword (2 Blades + 1 Heavy Weapon) requires deeper investment in the Heavy Weapon path.
