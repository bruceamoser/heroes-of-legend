...
Weapons don't deal damage on their own. Your attack ability cards carry the Weak, Standard, and Strong damage values (see @sec-chapter-talents-abilities). A weapon's Disciplines gate which attack ability cards you can take, not how hard they hit. The 3d6 attack roll determines how well you struck. No separate damage dice.

| Weapon | Disciplines Required | Properties | Cost |
|--------|---------------------|-----------|------|
| Unarmed | None | | |
| Dagger | 1 Blades | Finesse, Light, Thrown | |
| Shortsword | 1 Blades | Finesse, Light | |
| Longsword | 2 Blades | Versatile | |
| Greatsword | 2 Blades + 1 Heavy Weapon | | |
| Handaxe | 1 Axes | Light, Thrown | |
| Battleaxe | 2 Axes | | |
| Greataxe | 2 Axes + 1 Heavy Weapon | | |
| Mace | 1 Heavy Weapon | | |
| Warhammer | 2 Heavy Weapon | | |
| Maul | 3 Heavy Weapon | | |
| Spear | 1 Polearms | Reach, Thrown | |
| Halberd | 1 Polearms | Reach | |
| Throwing Dagger | 1 Blades or 1 Archery | Finesse, Thrown | 2 gp |
| Shortbow | 1 Archery | | |
| Longbow | 1 Archery | | |
| Crossbow | 1 Archery | Loading | |
...
::: {.callout-note}
## Melee Damage
Melee attacks add your Brawn to the damage row on your attack ability card; Finesse weapons use Agility instead. Missile and thrown attacks add Agility. See @sec-chapter-talents-abilities for the cards and @sec-chapter-combat for the basic attack. The weapon never changes these numbers.
:::

::: {.callout-note}
## Discipline Combinations, Build Your Fighting Style

Weapons don't just require more of the same Discipline, they require specific combinations. A Longsword needs *2 Blades*. A Greatsword needs *2 Blades + 1 Heavy Weapon*. Your Discipline choices define which attack ability cards you can take, not how hard they hit. A Greatsword (2 Blades + 1 Heavy Weapon) qualifies you for heavy attack cards; a Dagger (1 Blades) does not. Your fighting style is the card ladder you can access.

**Heavy Weapon** Discipline represents training with large, two-handed weapons that rely on momentum and raw force rather than finesse. It gates access to the heaviest attack cards.
:::
...
| **Caltrops (bag)** | 1 gp | 1 | Scatter across a 5-ft square as a maneuver. A creature moving through must make an Agility check (Standard) or take 1 damage and halve its speed until the end of its next turn. |
| **Chalk (5 pieces)** | 5 cp | 0 | Mark walls, leave signals, draw ritual circles. Breaks easily. Costs nothing. |
| **Crowbar** | 2 gp | 1 | Boon on Brawn checks to force open doors, chests, or grates. Makes a loud noise, no subtlety. Can be used as an improvised weapon (1/1/2 damage). |
...
| **Volatile Reagents (alchemist's fire)** | 10 gp | 1 | A vial of unstable chemicals. Thrown as an improvised attack, 2 fire damage on hit, plus 1 ongoing fire damage until the target spends an action to put it out. |
...
**Controlling a Mount:** You direct your mount using the Command maneuver, no roll required for trained mounts (warhorses, riding horses with riders who have Survival or Nature). For untrained mounts or in chaotic situations (explosions, dragon fear, the horse just took an arrow), the DA may require a Survival or Nature check (Standard) to keep control.

**Fighting from a Moving Mount:** Ranged attacks made from a moving mount suffer a -2 penalty. The horse's gait throws off your aim. If you have Survival or Nature at Adept or higher, this penalty is reduced to -1. At Master rank, you ignore it entirely, you could thread an arrow through a keyhole at full gallop.
