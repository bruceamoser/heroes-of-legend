...
| **Recruit** | Gain 1d3 temporary followers for the next adventure. They're hirelings, not heroes, use the Guard or Bandit stat block from `@sec-chapter-bestiary`{=typst}. They follow reasonable orders but won't sacrifice themselves. |
...
**Followers use simple NPC stat blocks** (Guard, Bandit, Cultist, see `@sec-chapter-bestiary`{=typst}). They maintain the stronghold, handle mundane tasks, and provide minor mechanical benefits:
