...
| **Defense** | FO | Armor | Dodging, blocking, and personal defense |
...
| **Adept** | +2 | — | — | — | **Pin Down**, Target hit with bow has Bane on attacks until it moves 5 ft. Disc: Archery (2). |
...
| **Adept** | +2 | — | — | — | **Feint**, Next attack against you before your next turn is at Bane. |
...
| **Master** | +3 | — | — | — | **Perfect Counter**, Choose a creature. Its next attack against you is at Bane. |
...
| **Master** | +3 | — | — | — | **Terrifying Presence**, All foes within 30 ft make a Morale Check at Bane. |
...
| Tier | Bonus | X1 | X2 | X3 | Maneuver |
|------|-------|----|----|----|----------|
| **Novice** | +1 | Blade, Leader | Protector, Arcanist, Shepherd, Intellect, Odd, Unbalanced | — | — |
| **Adept** | +2 | — | — | — | **Eagle Eye**, On Standard+ Perception check, the DA reveals one hidden detail others missed. |
| **Master** | +3 | — | — | — | **Uncanny Awareness**, You cannot be surprised. You always act in the first round of combat. |
...
|------|-------|----|----|----|----------|
| **Novice** | +1 | Arcanist, Intellect | Protector, Blade, Shepherd, Odd, Leader, Unbalanced | — | — |
| **Adept** | +2 | — | — | — | **Esoteric Knowledge**, Recite a relevant legend, heraldic lineage, or obscure fact. DA may grant Boon on a related check. |
| **Master** | +3 | — | — | — | **True Name**, After observing a creature for one round, identify its true nature or a hidden weakness. |
...
|------|-------|----|----|----|----------|
| **Novice** | +1 | Shepherd | Protector, Blade, Arcanist, Intellect, Odd, Leader, Unbalanced | — | — |
| **Adept** | +2 | — | — | — | **Soothing Voice**, Calm a hostile or frightened beast within 30 ft. It will not attack for 1 round. Disc: Animal (1). |
| **Master** | +3 | — | — | — | **Beast Bond**, Your mount or animal companion gains +2 on its next attack or skill check. Disc: Animal (2). |
...
|------|-------|----|----|----|----------|
| **Novice** | +1 | — | Protector, Blade, Arcanist, Shepherd, Intellect, Odd, Leader, Unbalanced | — | — |
| **Adept** | +2 | — | — | — | **True North**, You always know which way is north and can retrace any path you have traveled. |
| **Master** | +3 | — | — | — | **Pathfinder's Instinct**, Once per session, the DA reveals the safest route to a known destination within one day's travel. |
...
|------|-------|----|----|----|----------|
| **Novice** | +1 | — | Protector, Blade, Arcanist, Shepherd, Intellect, Odd, Leader, Unbalanced | — | — |
| **Adept** | +2 | — | — | — | **Captivate**, One creature within 30 ft that can see and hear you must save vs Guile or be Distracted until end of your next turn. |
| **Master** | +3 | — | — | — | **Inspire Greatness**, All allies within 30 ft who can hear you gain +1 on their next roll. |
...
|------|-------|----|----|----|----------|
| **Novice** | +1 | Blade, Odd | Protector, Arcanist, Shepherd, Intellect, Leader, Unbalanced | — | — |
| **Adept** | +2 | — | — | — | **Quick Hands**, Pick a lock or disarm a trap as a maneuver instead of an action. |
| **Master** | +3 | — | — | — | **Shadow's Touch**, On successful lockpick or trap disarm, attempt a second such action immediately at -2. |
