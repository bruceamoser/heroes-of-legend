...
| Strong (15-18+) | 1d6+2 ice damage. Target's next physical action has Bane as cold numbs their limbs. |
...
| Standard (9-14) | 4d6 damage (half fire, half radiant) in a 10-foot radius. Undead and fiends have Bane on any save against it. |
...
| Standard (9-14) | 3d6 ice damage per round in a 40-foot radius. Heavy obscurement, attacks into or out of the storm have Bane. Difficult terrain. |
...
| Standard (9-14) | 2d6 ice damage. The target's next attack has Bane as numbness sets in. |
...
| Standard (9-14) | +3 Armor. Melee attackers take 2d6 ice damage. You are immune to cold damage. Fire attacks against you have Bane, the ice fights back. |
...
| Strong (15-18+) | 1d6 lightning damage in the aura. Creatures damaged have Bane on attacks against you while they remain in the field, their muscles won't cooperate. |
...
| Strong (15-18+) | 5 missiles. Each deals 1d4+1 force damage. One target of your choice struck by at least two missiles is staggered, its next attack has Bane. |
...
| Strong (15-18+) | 6d6 necrotic damage per touch. Heal for half. Each successful touch also weakens the target, it has Bane on its next attack. You gain +1 Armor (stacks up to +3) as stolen vitality shields you. |
...
| Outcome | Effect |
|---------|--------|
| Weak (1-8) | 4d6 necrotic damage. Target is sickened, Bane on attacks for 1 round. |
...
| | | | | |
| Chill Touch | Novice | Ice | 1 Water | 2d6 ice, touch, Bane on next attack |
